/*
Try to map every inedible tail into some integer inside [L,R] in some way to avoid double counting.
We can count the number of mappings in some order. (don't know how to explain :( )
*/
#include<iostream>
#include<algorithm>
#include<queue>
