/*
Optimal solution is (p[y]-p[k]+a[k]*(x-(y-k))) for some y-x+1<=k<=y
Do convex hull for each segtree range, and then query can be done easily
Can be made O(NlogN) with little care
*/
#include<iostream>
#include<queue>
#include<algorithm>
