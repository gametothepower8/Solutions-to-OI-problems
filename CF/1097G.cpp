/*Trick from Errichto https://codeforces.com/blog/entry/62792 Q6.
  Need to count (un)ordered pairs with no repeats instead of allowing repeats to have good complexity.
  Compute the final answer with help of stirling numbers of 2nd kind.
*/
#include<iostream>
#include<queue>
using namespace std;
