/*
Compute SG values for those (last occurence of char x before prefix i,i]
Do this for prefix and suffix
With aid of some prefix sums as well, can be calculated qucikly
*/
#include<iostream>
#include<array>
#include<algorithm>
